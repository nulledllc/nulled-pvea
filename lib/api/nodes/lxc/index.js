export default class lxc {
  ...
  async deleteContainerSnapshot(node, vmid, snapshotName) {
    return await this.del(`/nodes/${node}/lxc/${vmid}/snapshot/${snapshotName}`)
  }

  async listContainerSnapshotConfig(node, vmid, snapshotName) {
    return await this.get(`/nodes/${node}/lxc/${vmid}/snapshot/${snapshotName}/config`)
  }

  async updateContainerSnapshotDescription(node, vmid, snapshotName, params) {
    return await this.put(`/nodes/${node}/lxc/${vmid}/snapshot/${snapshotName}/config`, params)
  }

  async rollbackContainerToSnapshot(node, vmid, snapshotName, params) {
    return await this.post(`/nodes/${node}/lxc/${vmid}/snapshot/${snapshotName}/rollback`, params)
  }
